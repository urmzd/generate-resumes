...
\achievements%
[Implemented cloud-based microservices to process millions of records at scale using AWS Batch, S3, and SES.]%
[Enabled engineers to rapidly tackle stories within sprint by outlining scope and providing candidate solutions.]
\project{Software Engineer}{ReelData}{Aug 2021 - Apr 2022}
\subproject{Halifax, Nova Scotia}
\achievements%
[Engineered QA automation tool, reducing client QA times by 90\% and, enabling data collection for R\&D purposes.]%
...
\achievements%
[A framework for resolving various machine learning tasks using linear genetic programming.]
